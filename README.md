...
### 🚀 About Me  
- 🎓 Pursuing **B.Tech in Information Technology** from **Sir C.R.Reddy College Of Engineering (2021–2025)**  
- 💻 Passionate about **MERN Stack**, **AI**, and **Cloud Solutions (AWS)**  
- 🎯 Building scalable web apps & automating workflows  
- 🌱 Currently exploring **AWS**, **Python Automation**, and **AI Tools Integration**  
...
|----------|--------------|-------|
| ☁️ **Weather App** | Fetches real-time weather data using API with a simple, clean UI. | 🔗 [Live Demo](https://weathermood.netlify.app/) • [View Code](https://github.com/3nadh3/weather-app) |
| 🏫 **Student Request Hub** | Web app for handling college student requests digitally. | 🔗 [Live Demo](https://studenthub.netlify.app/) • [View Code](https://github.com/3nadh3/student-request-hub) |
| 📊 **Data Analysis Web App** | Analyzes and visualizes datasets interactively. | 🔗 [Live Demo](https://dataanalyze.netlify.app/) • [View Code](https://github.com/3nadh3/data-analysis-web-app) |
| 💬 **Chatbot Integration** | AI chatbot built using Google AI Studio & Node.js backend. | 🔗 [Live Demo](https://trinadhportfolio.netlify.app/) • [View Code](https://github.com/3nadh3/chatbot-integration) |
...
<p align="center">
  <img width="49%" src="https://github-readme-stats.vercel.app/api?username=3nadh3&show_icons=true&theme=radical" />
  <img width="49%" src="https://github-readme-streak-stats.herokuapp.com/?user=3nadh3&theme=radical" />
</p>
